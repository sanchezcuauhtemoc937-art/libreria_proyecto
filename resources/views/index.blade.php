...
<body class="p-3 mb-2 bg-black text-white">
    <div id="container">
        ...
        <div class="text-center">
            <h1 class="text-primary">Bienvenido a la Librería</h1>
            <nav class="navbar bg-body-tertiary">
  <div class="container-fluid">
    <a class="navbar-brand">Busca Tu Libro</a>
...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        <a class="nav-link" href="#">Ubicacion</a>
            ...
            <p class="lead">Explora nuestros libros y categorías</p>
  ...
  <ul class="dropdown-menu">
    <li><button class="dropdown-item" type="button">Accion</button></li>
    <li><button class="dropdown-item" type="button">Amor</button></li>
    <li><button class="dropdown-item" type="button">Suspenso</button></li>
  </ul>
</div>
            </ul>
        </div>
